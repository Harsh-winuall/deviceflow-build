...
function CoachmarksTwo({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="bg-white flex flex-col gap-3 ">
      <div className="w-full h-[180px] relative overflow-hidden rounded bg-[#f3f3f3]">
        ...
        <Image
          src="/media/coachmarks/workflow-2.svg"
          alt="CoachMark"
          width={300}
          height={180}
          priority
      ...
      <p className="text-sm text-[#00000080] font-gilroyMedium text-start leading-relaxed">
        Click on the onboarding workflow template to begin automating your
        recurring tasks and streamline the entire employee onboarding process
        more efficiently.
      </p>
