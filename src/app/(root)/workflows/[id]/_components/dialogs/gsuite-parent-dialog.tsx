...
function GSuiteParentDialog({
  ...
  return (
    <Dialog>
      ...
      <SideDialogContent className="flex flex-col gap-0 overflow-y-visible h-[35rem] rounded-xl p-0 max-w-md [&>button:last-child]:top-8">
        ...
        <div className="px-3 pt-3 pb-0 h-full w-full overflow-y-auto hide-scrollbar">
          <Form {...form}>
            <form
...
export default GSuiteParentDialog;
