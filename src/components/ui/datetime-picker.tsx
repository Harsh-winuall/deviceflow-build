...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 font-gilroyRegular", className)}
      classNames={{
        months:
          ...
          return (
            <div className="inline-flex gap-2">
              ...
              >
                ...
                <SelectContent className="font-gilroyRegular">
                  {MONTHS.map((month) => (
                    <SelectItem
                      key={month.value}
              ...
              >
                <SelectTrigger className="focus:bg-accent justify-between focus:text-accent-foreground w-fit gap-1 border-none p-0">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="font-gilroyRegular">
                  {YEARS.map((year) => (
      ...
      <Popover>
        <PopoverTrigger asChild disabled={disabled}>
          ...
          >
            ...
            {showIcon && <CalendarIcon className="ml-2 h-4 w-4" />}
          </Button>
        </PopoverTrigger>
